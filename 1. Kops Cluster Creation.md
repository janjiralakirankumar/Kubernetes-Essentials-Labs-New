...
```
##### Once Scaling (Up/Down) is done and If you are unable to retrieve the data of nodes or the cluster, you can use the following command. This command is particularly useful if you have downscaled or upscaled it again:
```
